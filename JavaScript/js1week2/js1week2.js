...
advertise(["motorbike"]);
advertise(["motorbike", "caravan"]);
advertise(["motorbike", "caravan", "truck", "bike", "car"]);
advertise(["motorbike", "caravan", "truck", "bike", "car", "trike"]);
...
techObject = { HTML: "Victor", github: "Tommy", Javascript: "Shamrat", homeWork: "Wojtek" };
console.log(techObject);
