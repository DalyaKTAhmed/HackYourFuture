...
//value = {this.state.item} we add tis to empty the input after adding the item on it

    render(){
       return (
           <div>
               <form onSubmit = {this.hadelSubmit}>
                   <input type = "text" placeholder = "Enter item..." id = "item" onChange = {this.handelChange} value = {this.state.item}/ >         
